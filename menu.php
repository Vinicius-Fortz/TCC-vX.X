        ...
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                  <div class="header__actions"><a href="#">Login</a>
      ...
      <nav class="navigation">
        <div class="container-fluid">
          <div class="navigation__column left">
            <div class="header__logo"><a class="ps-logo" href="index.html"><img src="images/logoriogrande.png" alt="" width="75px"></a></div>
          </div>
          <div class="navigation__column center">
                <ul class="main-menu menu">
                    ...
                    <div class="mega-menu">
                      <div class="mega-wrap">
                        ...
                        <div class="mega-column">
                          ...
                          <ul class="mega-item">
                            <li><a href="product-listing.html">Lixos</a></li>
                            <li><a href="product-listing.html">Panos</a></li>
                            <li><a href="product-listing.html">Vassouras</a></li>
                          </ul>
                        </div>
                        <div class="mega-column">
                          <h4 class="mega-heading">Piscina</h4>
                          <ul class="mega-item">
                            <li><a href="product-listing.html">Cloro</a></li>
                          </ul>
                        </div>
                        <div class="mega-column">
                  ...
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">Empresa</a>
                        <ul class="sub-menu">
